      ...
      <div className='p-6'>
        ...
        <div className="flex gap-4">
          <a
            ...
            className="px-4 py-2 bg-purple text-white rounded-lg text-sm hover:bg-purple-700 transition"
          >
            Live Demo
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2 border border-purple text-white rounded-lg text-sm hover:bg-purple/20 hover:text-white transition"
          >
            GitHub
          </a>
        </div>
