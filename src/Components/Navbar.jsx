            ...
            <div className='container mx-auto flex justify-between items-center'>
                ...
                <div>
                    <a href='#' className='text-3xl font-bold text-white'>
                        Tech<span className='text-purple'> Voyager</span>
                    </a>
                </div>
                ...
                <div className='md:hidden'>
                    {
                        showMenu ?
                            <FaXmark onClick={() => setShowMenu(!showMenu)} className='text-2xl cursor-pointer duration ' /> :
...

            {
                showMenu && (
                    <div className='md:hidden mt-4 bg-dark-300 h-screen rounded-lg p-4 flex flex-col space-y-4 text-center'>
                        <a href="#home" onClick={() => setShowMenu(!showMenu)} className='relative text-white/80 transition duration-300 hover:text-purple group'>
                            <span>Home</span>
                            <span className='absolute left-0 -bottom-1 w-0 h-0.5 bg-purple transition-all duration 300 group-hover:w-full'></span>
                        </a>
                        ...
                        <a href="#Education" onClick={() => setShowMenu(!showMenu)} className='relative text-white/80 transition duration-300 hover:text-purple group'>
                            <span>Education</span>
